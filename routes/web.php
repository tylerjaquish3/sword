...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/digest/{shared}/edit', [SharedDigestController::class, 'edit'])->name('digest.edit');
    Route::put('/digest/{shared}', [SharedDigestController::class, 'update'])->name('digest.update');
